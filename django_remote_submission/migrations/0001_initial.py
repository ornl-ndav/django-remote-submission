# -*- coding: utf-8 -*-
# Generated by Django 1.10.3 on 2016-11-15 20:21
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', model_utils.fields.StatusField(choices=[('initial', 'initial'), ('edited', 'edited'), ('submitted', 'submitted'), ('success', 'success'), ('failure', 'failure')], default='initial', help_text='The current status of the program', max_length=100, no_check_for_status=True, verbose_name='Job Status')),
